            ...
            <div class="invoice">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <a href="#">
                            <img src="<?php echo ADMIN_ASSETS ?>images/logo-mbc-fix.png" width="400" alt="" />
                        </a>
                    </div>
                </div>
                ...
                <?php foreach ($bundle as $b) {
                    
                } ?>
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th width="100%" colspan="3" class="text-center"><font color="black"><?php echo $b->nama_bundle ?></font></th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        foreach ($produk as $p) {
                            ...
                            <td class='text-right' style=\"display: table-cell; vertical-align: middle; \">";

                            if ($p->id_produk_bundle == 0) {
                                echo "<strong>Rp " . number_format($p->harga, 0, ",", ".") . "</strong>";
                            } else {
                                echo "x1";
                            }
                            echo "</td></tr>";
