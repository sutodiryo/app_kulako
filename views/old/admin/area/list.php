...
<body>
                    ...
                    <div class="ibox-body">
                        <div class="flexbox mb-4">
                            <div class="flexbox">
                                ...
                                <button class="btn btn-outline-success btn-fix btn-air" title="Tambah Area Baru" data-toggle="modal" data-target="#modal_tambah_area" href="javascript:;"><i class="la la-plus"></i> Tambah Area Baru</button>
                            </div>
                            ...
                            <table class="table table-bordered table-hover" id="datatable">
                                ...
                                <tbody>
                                    <?php foreach ($area as $c) {
                                        echo "<tr>
                                        <td><a href='javascript:;'>$c->id_area</a></td>
                                        <td>$c->nama</td>
                                        <td>$c->value_name</td>
                                        <td>$c->value</td>
                                        <td>
        ...
        function edit(id_value) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#modal_tambah_area_value').modal('show'); // show bootstrap modal when complete loaded
    ...
    <!-- New question dialog-->
    <div class="modal fade" id="modal_tambah_area">
        <div class="modal-dialog" style="width:900px;" role="document">
            <div class="modal-content timeout-modal">
                <div class="modal-body">
                    <button class="close" data-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center h4 mb-3">Tambah area Baru</div>

                    <div id="timeout-activate-box">

                        <form action="<?php echo base_url('/admin/act/add_area/'); ?>">
