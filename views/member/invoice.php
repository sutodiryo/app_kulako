                ...
                <div class="row">
                    ...
                    <div>
                        ...
                        $transaksi  = $this->db->query("SELECT  id_transaksi,id_produk,id_affiliate,id_member,id_produk_bundle,bundle,total,tgl_checkout,bukti_transfer,tgl_bayar,status,
                                                                ...
                                                                FROM transaksi WHERE id_member='$id_member' AND id_produk_bundle='1'")->result();
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <ul class="list-unstyled text-center">
                            ...
                            <a target="_blank" href="https://api.whatsapp.com/send?phone=62<?php if (empty($t->no_hp)) {
                                                                                                echo "85647341274";
                                                                                            } else {
                                                                                                echo $t->no_hp;
                                                                                            } ?>&text=Assalamualaikum%0ASaya%20sudah%20transfer%20sebesar%20<?php echo "Rp " . number_format($total, 0, ",", ".") . ""; ?>%2C%20dari%20rekening%20saya%20atas%20nama%20rekening%20pengirim%20%3A%0ATerima%20kasih%2C%20mohon%20panduan%20selanjutnya" class="btn btn-lg btn-success btn-icon">
                                Konfirmasi Pembayaran Lewat WA
                                <i class="fa fa-whatsapp"></i>
                            </a>
                            <!-- <a href="<?php echo base_url('member/ruang_kelas') ?>" class="btn btn-lg btn-danger btn-icon">
                                Kembali 
