                                                            ...
                                                            <div class="panel-collapse collapse in" id="c1" aria-expanded="true" style="">
                                                                ...
                                                                <div class="media-body">
                                                                    <div class="comment-meta">
                                                                        ...
                                                                        <?php $sub_komen    = $this->db->query("SELECT 	id,id_up,id_produk_link,komen,status,id_member,
																								(SELECT nama FROM member WHERE id_member=produk_link_comment.id_member) AS member
                                                                        ...
                                                                        <div class="collapse in" id="reply1" aria-expanded="true" style="">
                                                                            <form method="POST" action="<?php echo "" . base_url('member/komentar/') . "$l->id_produk_link"; ?>">
                                                                                <div class="form-group">
                                                                                    <input type="hidden" name="id_up" value="<?php if ($this->session->userdata('log_admin') == TRUE) {
                                                                                                                                                    echo "-1";
                                                                                                                                                } else {
                                                                                                                                                    echo "$k->id";
                                                                                                                                                } ?>">
                                                                    ...
                                                                    <?php
                                                                                    ...
                                                                                    foreach ($sub_komen as $sk) {
                                                                                        $nosk++; ?>
                                                                    <div class="media">
                                                                        <div class="media-heading"><?php if ($sk->id_member = -1) {
                                                                                                                            echo "Coach Fitra Jaya Saleh";
                                                                                                                        } else {
                                                                                                                            echo $sk->member;
                                                                                                                        } ?> : <?php echo $sk->komen ?></div>
