            ...
            <div class="invoice">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <a href="#">
                            <img src="<?php echo ADMIN_ASSETS ?>images/logo-mbc-beli.png" width="350" alt="" />
                        </a>
                    </div>
                </div>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th width="100%" colspan="2" class="text-center">
                                <font color="black">KELAS ONLINE MEMBANGUN BISNIS BERSAMA COACH FJS</font>
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        foreach ($bundle as $b) {
                            $no++;
                            echo "<tr>
                            <td><img src='" . base_url('assets/upload/produk/') . "" . $b->cover . "' height='80'> $b->nama_bundle</td>
                            <td class='text-right' style=\"display: table-cell; vertical-align: middle; \">x$b->total_video Video</td>
                            </tr>";
                        }

                        echo "<tr class='list-unstyled'>
                        <td class='text-right' style=\"display: table-cell; vertical-align: middle; \"><font color='orange'>Diskon</font></td>
                        <td class='text-right'><font color='orange'><strong>- Rp " . number_format(00, 0, ",", ".") . "</strong></font></td>
                        </tr>
                        
                        <tr class='list-unstyled'>
                        <td class='text-right' style=\"display: table-cell; vertical-align: middle; \"><font color='black'>TOTAL</font></td>
                        <td class='text-right' style=\"display: table-cell; vertical-align: middle; \"><h4><strong><font color='red'>Rp " . number_format($b->harga, 0, ",", ".") . "</font></strong></h4></td>
                        </tr>";
                        foreach ($produk as $p) {
                            # code...
                        }
                            ...
                            <div class="col-sm-6 col-xs-6">
                                <div class="text-right">
                                    ...
                                    <form action="<?php echo base_url('ref/process') ?>" method="POST">
                                        <input name="id_produk_bundle" type="hidden" value="<?php echo $b->id_produk_bundle ?>">
                                        ...
                                        <input name="total" type="hidden" value="<?php echo $b->harga ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="<?php echo base_url('ref/checkout') ?>" role="form" method="POST" class="validate" novalidate="novalidate">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email" id="email" onchange="return check_email();" data-validate="required,email" placeholder="Email">
                                        </div>
