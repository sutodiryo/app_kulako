...
<div class="page-container">
				...
				<ul class="user-info pull-left pull-none-xsm">
					...
					<li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img src="<?php echo ADMIN_ASSETS ?>images/thumb-1@2x.png" alt="" class="img-circle" width="44" />
							John Henderson
						</a>
							...
							<li>
								...
								<ul class="dropdown-menu-list scroller">
									<li class="active">
										<a href="#">
											<span class="image pull-right">
												<img src="<?php echo ADMIN_ASSETS ?>images/thumb-1@2x.png" width="44" alt="" class="img-circle" />
											</span>
									...
									<li class="active">
										<a href="#">
											<span class="image pull-right">
												<img src="<?php echo ADMIN_ASSETS ?>images/thumb-2@2x.png" width="44" alt="" class="img-circle" />
											</span>
									...
									<li>
										<a href="#">
											<span class="image pull-right">
												<img src="<?php echo ADMIN_ASSETS ?>images/thumb-3@2x.png" width="44" alt="" class="img-circle" />
											</span>
									...
									<li>
										<a href="#">
											<span class="image pull-right">
												<img src="<?php echo ADMIN_ASSETS ?>images/thumb-4@2x.png" width="44" alt="" class="img-circle" />
											</span>
				...
				<ul class="list-inline links-list pull-right">
					...
					<li class="dropdown language-selector">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
							<img src="<?php echo ADMIN_ASSETS ?>images/flags/flag-uk.png" width="16" height="16" />
						</a>
		
						<ul class="dropdown-menu pull-right">
							<li>
								<a href="#">
									<img src="<?php echo ADMIN_ASSETS ?>images/flags/flag-de.png" width="16" height="16" />
									<span>Deutsch</span>
								</a>
							</li>
							<li class="active">
							...
							<li>
								<a href="#">
									<img src="<?php echo ADMIN_ASSETS ?>images/flags/flag-fr.png" width="16" height="16" />
									<span>François</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="<?php echo ADMIN_ASSETS ?>images/flags/flag-al.png" width="16" height="16" />
									<span>Shqip</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="<?php echo ADMIN_ASSETS ?>images/flags/flag-es.png" width="16" height="16" />
									<span>Español</span>
								</a>
							</li>
						</ul>
	...
	<link rel="stylesheet" href="<?php echo ADMIN_ASSETS ?>js/fullcalendar-2/fullcalendar.min.css">
	...
	<script src="<?php echo ADMIN_ASSETS ?>js/moment.min.js"></script>
	<script src="<?php echo ADMIN_ASSETS ?>js/fullcalendar-2/fullcalendar.min.js"></script>
	<script src="<?php echo ADMIN_ASSETS ?>js/neon-calendar-2.js"></script>
