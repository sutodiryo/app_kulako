				...
				<div class="col-md-12">
					...
					<div class="panel panel-primary" data-collapsed="0">
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal form-groups-bordered" method="POST" action="<?php echo base_url('admin/act/edit_area/'); echo $id;?>">

								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Nama Area</label>
									<div class="col-sm-5">
										<input type="text" class="form-control" name="nama_area" required value="<?php echo $nama ?>">
									</div>
								</div>

								<div class="form-group">
									<label for="field-ta" class="col-sm-3 control-label">Kode Area</label>
									<div class="col-sm-5">
										<input type="text" class="form-control" name="kode_area" value="<?php echo $kode ?>">
									</div>
								</div>

								<div class="form-group">
									<label for="field-ta" class="col-sm-3 control-label">Admin</label>
									<div class="col-sm-5">
								...
								<div class="form-group">
									<label for="field-ta" class="col-sm-3 control-label">Alamat Kantor</label>
									<div class="col-sm-5">
										<textarea class="form-control" name="alamat_kantor"><?php echo $alamat ?></textarea>
									</div>
								</div>

								<div class="form-group">
									<label for="field-ta" class="col-sm-3 control-label">Latitude</label>
									<div class="col-sm-5">
										<input type="text" class="form-control" name="latitude" value="<?php echo $lat ?>">
									</div>
								</div>

								<div class="form-group">
									<label for="field-ta" class="col-sm-3 control-label">Longitude</label>
									<div class="col-sm-5">
										<input type="text" class="form-control" name="longitude" value="<?php echo $long ?>">
									</div>
								</div>
